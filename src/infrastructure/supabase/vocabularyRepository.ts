...
export function mapRowToVocabularyEntity(row: VocabularyRow): VocabularyEntity {
  return {
    ...
    wordKo: row.word_ko,
    wordTl: row.word_tl,
    wordTh: (row as any).word_th,
    wordVi: (row as any).word_vi,
    wordJa: (row as any).word_ja,
    exampleEn: row.example_en,
    exampleKo: row.example_ko,
    exampleTl: row.example_tl,
    exampleTh: (row as any).example_th,
    exampleVi: (row as any).example_vi,
    exampleJa: (row as any).example_ja,
    phoneticEn: row.phonetic_en,
    phoneticKo: row.phonetic_ko,
    phoneticTl: row.phonetic_tl,
    phoneticTh: (row as any).phonetic_th,
    phoneticVi: (row as any).phonetic_vi,
    phoneticJa: (row as any).phonetic_ja,
